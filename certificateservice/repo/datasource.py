...
class DataSource(metaclass=Singleton):
    def __init__(self):
        ...
        try:
            ...
            print("DATABASE_URL from env:", os.getenv("DATABASE_URL"))  # Debug print statement
...
try:
    DataSource().create_or_migrate_tables()
except Exception as e:
    logger.error(f"Failed to create or migrate tables at startup: {e}")
